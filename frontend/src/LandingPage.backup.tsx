...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white selection:bg-red-500/30 font-sans overflow-x-hidden">
      ...
      {/* Navigation */}
      <nav className="fixed w-full z-50 top-0 backdrop-blur-md border-b border-white/5 bg-[#0a0a0f]/80">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-red-500 to-orange-500 rounded-full font-semibold text-lg flex items-center justify-center gap-2 hover:shadow-[0_0_20px_rgba(239,68,68,0.4)] transition-all"
            >
      ...
      {/* Team & Footer */}
      <footer id="team" className="px-6 py-20 border-t border-white/5 bg-[#0a0a0f]">
